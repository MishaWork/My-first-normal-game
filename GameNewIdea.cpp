...
void Car1 (HDC Track, HDC car1, HDC car2)
    ...
    while (1 < 2)
        ...
        printf ("я убил тхлиб %d, ", xSource2);

        if (xSource2 > 11264 - 176) xSource2 = 0, printf ("ем кислый кумы гжичч %d, ", xSource2);
        if (xSource2 < 0) xSource2 = 11264 - 176, printf ("cъел бомжа мал гжичч %d, ", xSource2);

        printf ("я убил тхлибопять %d\n", xSource2);
